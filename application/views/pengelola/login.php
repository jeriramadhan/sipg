...
<body>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <h2 class="panel-title"><center><img src="<?php echo base_url();?>assets/images/" width="25">  PENGELOLA Gedung G UNJ</center></h2>
                    </div>
    ...
    <!-- jQuery -->
    <script src="<?php echo base_url();?>templates/peserta/vendor/jquery/jquery.min.js"></script>

    <!-- Bootstrap Core JavaScript -->
    <script src="<?php echo base_url();?>templates/peserta/vendor/bootstrap/js/bootstrap.min.js"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="<?php echo base_url();?>templates/peserta/vendor/metisMenu/metisMenu.min.js"></script>

    <!-- Custom Theme JavaScript -->
    <script src="<?php echo base_url();?>templates/peserta/dist/js/sb-admin-2.js"></script>
