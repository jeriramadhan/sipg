    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>unit">Sistem Informasi Pendaftaran Gedung G UNJ</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li><a href="<?php echo base_url();?>unit"><i class="fa fa-home fa-fw"></i> Beranda</a></li>
                        <li><a href="<?php echo base_url();?>unit/pendaftaran"><i class="fa fa-check fa-fw"></i> Konfirmasi</a></li>
                        <li><a href="<?php echo base_url();?>unit/deadline"><i class="fa fa-clock-o fa-fw"></i> Deadline</a></li>
                        <li><a href="<?php echo base_url();?>unit/anggota"><i class="fa fa-users fa-fw"></i> Data Anggota</a></li>
                        <li><a href="<?php echo base_url();?>unit/alumni"><i class="fa fa-users fa-fw"></i> Data Alumni</a></li>
                        <li><a href="<?php echo base_url();?>unit/history"><i class="fa fa-history fa-fw"></i> Riwayat Pendaftaran</a></li>
