    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>admin">Sistem Informasi Pendaftaran Gedung G UNJ</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li><a href="<?php echo base_url();?>admin/peserta"><i class="fa fa-users fa-fw"></i> Data Peserta</a></li>
                        ...
                        <li><a href="<?php echo base_url();?>admin/unit"><i class="fa fa-university fa-fw"></i> Data Lembaga Yang Mengadakan</a></li>
