...
class M_internal extends CI_Model {
    ...
    public function delete_peserta($where){
        $this->db->delete("t_peserta", $where);
    }
	public function get_peserta($select, $where){
        $data = "";
		$this->db->select($select);
        $this->db->from("t_peserta m");
    ...
    public function grid_all_peserta($select, $sidx, $sord, $limit, $start, $where="", $like=""){
        $data = "";
        $this->db->select($select);
        $this->db->from("t_peserta m");
        $this->db->join('t_kelas k', 'm.kelas_id= k.kelas_id', 'left');
    ...
    public function count_all_peserta($where="", $like=""){
        $this->db->select("*");
...
//configurasi unit=====================================================================================================================
    ...
    public function update_unit($where,$data){
        $this->db->update("t_unit",$data,$where);
    }
    public function delete_unit($where){
        $this->db->delete("t_unit", $where);
    }
	public function get_unit($select, $where){
        $data = "";
		$this->db->select($select);
        $this->db->from("t_unit");
		$this->db->where($where);
    ...
    public function grid_all_unit($select, $sidx, $sord, $limit, $start, $where="", $like=""){
        $data = "";
        $this->db->select($select);
        $this->db->from("t_unit");
		if ($where){$this->db->where($where);}
