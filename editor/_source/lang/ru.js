...
CKEDITOR.lang['ru'] =
{
	...
	table :
	{
		...
		celunitace	: 'Внешний отступ ячеек',
		...
		invalidCelunitacing	: 'Внешний отступ ячеек (celunitacing) должен быть числом.',
		...
		cell :
		{
			...
			invalidCounitan	: 'Количество объединяемых колонок должно быть задано числом.',
