								...
								spacer,
								{
									...
									[
										...
										},
										{
											type : 'text',
											id : 'counitan',
											label : langCell.counitan,
											'default' : '',
											validate : validate.integer( langCell.invalidCounitan ),
											setup : function( element )
											{
												var attrVal = parseInt( element.getAttribute( 'counitan' ), 10 );
												if ( attrVal && attrVal  != 1 )
												 	this.setValue(  attrVal );
											},
											commit : function( selectedCell )
											{
												var value = parseInt( this.getValue(), 10 );
												if ( value && value != 1 )
													selectedCell.setAttribute( 'counitan', this.getValue() );
												else
													selectedCell.removeAttribute( 'counitan' );
											}
										},
										spacer,
										{
