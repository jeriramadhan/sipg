								...
								},
								{
									...
									[
										...
										},
										{
											...
											id : 'txtCelunitace',
											controlStyle : 'width:3em',
											label : editor.lang.table.celunitace,
											'default' : 1,
											validate : CKEDITOR.dialog.validate.number( editor.lang.table.invalidCelunitacing ),
											setup : function( selectedTable )
											{
												this.setValue( selectedTable.getAttribute( 'celunitacing' ) || '' );
											},
											commit : function( data, selectedTable )
											{
												if ( this.getValue() )
													selectedTable.setAttribute( 'celunitacing', this.getValue() );
												else
													selectedTable.removeAttribute( 'celunitacing' );
											}
										},
										{
											type : 'text',
